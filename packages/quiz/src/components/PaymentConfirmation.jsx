...
const PaymentConfirmation = ({ nombre, email, telefono, ubicacion, onCallRequest, bonoPrice = 125 }) => {
  ...
  const waUrl = `https://wa.me/${HC_WHATSAPP}?text=${waText}`;
    ...
    <div className="min-h-screen bg-[#F7F8FA]">
      ...
      <div className="max-w-lg mx-auto px-4 py-6">
        ...
        <a
          ...
          className="w-full bg-[#25D366] hover:bg-[#1EBE5D] text-white font-bold text-base py-4 rounded-xl shadow-lg flex items-center justify-center gap-2 mb-3 transition-colors"
        >
          <WhatsAppIcon size={22} />
          Háblanos por WhatsApp
        </a>
        <p className="text-center text-xs text-gray-500 mb-6">
          Te confirmamos el pago y agendamos tu cita en minutos
        </p>
        ...
        <div className="bg-[#4CA994]/5 border border-[#4CA994]/20 rounded-2xl p-5 mb-6">
          <div className="flex items-center gap-2 mb-4">
            ...
            <h3 className="font-bold text-gray-900">O reserva tú mismo</h3>
          </div>
